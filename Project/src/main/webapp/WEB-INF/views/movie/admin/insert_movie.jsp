		...
		<form action="InsertMovie.do" id="joinForm" method="POST" enctype ="multipart/form-data">
			<table>
				...
				<tbody>
					<tr>
						<th>제목</th>
						<td><input class="title" type="text" name="title" id="userName" value="제목"></td>
					</tr>
					<tr>
						<th>감독</th>
						<td><input class="director" type="text" name="director" id="userEmail" value="감독"></td>
					</tr>
					<tr>
						<th>배우</th>
						<td><input class="actor" type="text" name="actor" id="subject" value="배우"></td>
					</tr>
					<tr>
						<th>장르</th>
						<td>
					...
					<tr>
						<th>개봉일</th>
						<td><input class="releaseDate" type="text" id="releaseDate" name="releaseDate"></td>
					</tr>
					<tr>
						<th>상영종료일</th>
						<td><input class="endDate" type="text" id="endDate" name="endDate"></td>
					</tr>
					<tr>
						<th>러닝타임</th>
						<td><input class="runningTime" type="text" id="runningTime" name="runningTime" value="러닝타임"></td>
					</tr>
					<tr>
						<th>관람가</th>
						<td class="ageList">
					...
					<tr>
						<th>국가</th>
						<td><input class="country" type="text" id="country" name="country" value="국가"></td>
					</tr>
					<tr>
						<th>영화정보</th>
						<td><textarea class="info" name="info" id="info" value="영화정보"></textarea></td>
					</tr>
					<tr>
						<th>사진</th>
